...
import com.kkbbs.entity.vo.web.FormArticleDetailVO;
import com.kkbbs.entity.vo.web.FormArticleUpdateDetailVO;
import com.kkbbs.entity.vo.web.ForumArticleAttachmentVo;
...
public class ForumArticleController extends BaseController {
    ...
    public ResponseVO recordArticle(HttpSession session, Integer boardId, Integer pBoardId, Integer orderType, Integer pageNo) {
        ForumArticleQuery articleQuery = new ForumArticleQuery();
        articleQuery.setBoardId(boardId == null || boardId == 0 ? null : boardId);
        articleQuery.setpBoardId(pBoardId);
        articleQuery.setPageNo(pageNo);
