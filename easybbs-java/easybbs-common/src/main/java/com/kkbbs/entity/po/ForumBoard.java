...
public class ForumBoard implements Serializable {
    ...
    public String toString() {
        return "板块ID:" + (boardId == null ? "空" : boardId) + "，父级板块ID:" + (pBoardId == null ? "空" : pBoardId) + "，板块名:" + (boardName == null ? "空" : boardName) +
                "，封面:" + (cover == null ? "空" : cover) + "，描述:" + (boardDesc == null ? "空" : boardDesc) + "，排序:" + (sort == null ? "空" : sort) + "，0:只允许管理员发帖 " +
                "1:任何人可以发帖:" + (postType == null ? "空" : postType);
    }
}
